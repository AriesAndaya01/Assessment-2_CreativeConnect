...
const contactForm = document.querySelector('[data-project-request-form]');
...
if (contactForm) {
  ...
  const allInputs = contactForm.querySelectorAll('input:not([type="hidden"]), textarea, select');
  ...
  contactForm.addEventListener('submit', (event) => {
    ...
    successMessage.textContent = 'Submitting your request...';
